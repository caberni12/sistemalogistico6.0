...
/* =====================================================
   FLUJO FINAL PRO
   TECLADO BLOQUEADO POR DEFECTO
   SOLO BOTÓN ⌨️ ACTIVA ESCRITURA
   ===================================================== */
...
(function(){
  ...
  /* ================================
     ...
     ================================ */
  ["codigo","ubicacion","descripcion","cantidad","operador"].forEach(id=>{
  ...
  window.activarScan = function(tipo){
    ...
    // bloquear teclado siempre que se activa scanner
